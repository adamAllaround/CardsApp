...
class WithdrawalsController {
    ...
    ResponseEntity<Withdrawal> withdraw(@PathVariable Long cardId, @RequestBody Withdrawal request) {
        Optional<com.allaroundjava.cardops.model.Withdrawal> result = withdrawing.withdraw(new WithdrawCommand(cardId, request.getAmount()));
...
class Withdrawal {
    ...
    public Withdrawal(com.allaroundjava.cardops.model.Withdrawal withdrawal) {
